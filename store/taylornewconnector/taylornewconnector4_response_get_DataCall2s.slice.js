...
export const taylornewconnector4_get__read = createAsyncThunk(
  "taylornewconnector4_response_get_DataCall2s/taylornewconnector4_get__read",
  async payload => {
...
const taylornewconnector4_response_get_DataCall2sSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(taylornewconnector4_get__read.pending, (state, action) => {
